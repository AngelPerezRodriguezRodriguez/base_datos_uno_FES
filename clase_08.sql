...
SELECT 
DISTINCT DATE_FORMAT(fedita, '%Y/%m/%d') AS fecha,
DATE_FORMAT(fedita, 'El cambio fue el %W %d de %M del %Y') AS fecha_cambio
FROM alumnos
ORDER BY 1;
...
fedita
FROM alumnos
WHERE DATE_FORMAT(fedita, '%Y %m') = '2017 09'
ORDER BY 1;
...
DATE_ADD('2023-12-31 23:59:59', INTERVAL 1 YEAR) AS add_anio,
DATE_ADD('2023-12-31 23:59:59', INTERVAL 1 MONTH) AS add_mes,
DATE_ADD('2023-12-31 23:59:59', INTERVAL 1 DAY) AS add_dia,
DATE_ADD('2023-12-31 23:59:59', INTERVAL 1 HOUR) AS add_hora,
DATE_ADD('2023-12-31 23:59:59', INTERVAL 1 MINUTE) AS add_minuto,
DATE_ADD('2023-12-31 23:59:59', INTERVAL 1 SECOND) AS add_segundo;

SELECT 
'2023-12-31 23:59:59' AS fecha,
DATE_SUB('2023-12-31 23:59:59', INTERVAL 1 YEAR) AS add_anio,
DATE_SUB('2023-12-31 23:59:59', INTERVAL 1 MONTH) AS add_mes,
DATE_SUB('2023-12-31 23:59:59', INTERVAL 1 DAY) AS add_dia,
DATE_SUB('2023-12-31 23:59:59', INTERVAL 1 HOUR) AS add_hora,
DATE_SUB('2023-12-31 23:59:59', INTERVAL 1 MINUTE) AS add_minuto,
DATE_SUB('2023-12-31 23:59:59', INTERVAL 1 SECOND) AS add_segundo;
