...
/*
UNION es la suma de los renglones de una tabla más los renglones de la otra, pero para lograrlo
...
de los campos en la proyección de la operación.
*/
...
podemos tomar dichos campos como normales y ser filtrado con WHERE.
*/
